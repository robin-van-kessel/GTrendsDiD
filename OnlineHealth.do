*Creation of database of OnlineHealth
	...
	use "$data/$sub_file/daily_search_19_21_(`i').dta", clear
	egen w_OnlineHealth_19=mean(d_OnlineHealth_19) if year==2019, by(country week)
	egen w_OnlineHealth_20=mean(d_OnlineHealth_20) if year==2020, by(country week)
	egen w_OnlineHealth_21=mean(d_OnlineHealth_21) if year==2021, by(country week)

	gen d_OnlineHealth_19_21=.
	replace d_OnlineHealth_19_21=d_OnlineHealth_19 if year==2019
	replace d_OnlineHealth_19_21=d_OnlineHealth_20 if year==2020
	replace d_OnlineHealth_19_21=d_OnlineHealth_21 if year==2021
	
	*Generating the weekly search interest weights
	gen stand_OnlineHealth_19_21=.
	replace stand_OnlineHealth_19_21=d_OnlineHealth_19*(w_OnlineHealth_19_21/w_OnlineHealth_19) if year==2019
	replace stand_OnlineHealth_19_21=d_OnlineHealth_20*(w_OnlineHealth_19_21/w_OnlineHealth_20) if year==2020
	replace stand_OnlineHealth_19_21=d_OnlineHealth_21*(w_OnlineHealth_19_21/w_OnlineHealth_21) if year==2021
