*Creation of database of OnlineDoctor
	...
	use "$data/$sub_file/daily_search_19_21_(`i').dta", clear
	egen w_OnlineDoctor_19=mean(d_OnlineDoctor_19) if year==2016, by(country week)
	egen w_OnlineDoctor_20=mean(d_OnlineDoctor_20) if year==2017, by(country week)
	egen w_OnlineDoctor_21=mean(d_OnlineDoctor_21) if year==2018, by(country week)

	gen d_OnlineDoctor_19_21=.
	replace d_OnlineDoctor_19_21=d_OnlineDoctor_19 if year==2016
	replace d_OnlineDoctor_19_21=d_OnlineDoctor_20 if year==2017
	replace d_OnlineDoctor_19_21=d_OnlineDoctor_21 if year==2018
	
	*Generating the weekly search interest weights
	gen stand_OnlineDoctor_19_21=.
	replace stand_OnlineDoctor_19_21=d_OnlineDoctor_19*(w_OnlineDoctor_19_21/w_OnlineDoctor_19) if year==2016
	replace stand_OnlineDoctor_19_21=d_OnlineDoctor_20*(w_OnlineDoctor_19_21/w_OnlineDoctor_20) if year==2017
	replace stand_OnlineDoctor_19_21=d_OnlineDoctor_21*(w_OnlineDoctor_19_21/w_OnlineDoctor_21) if year==2018
